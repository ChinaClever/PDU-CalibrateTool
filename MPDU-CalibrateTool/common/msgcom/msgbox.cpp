...
QuMsgBox::QuMsgBox(QWidget *parent,const QString &strContext) : QMessageBox(parent)
{
...
WaringMsgBox::WaringMsgBox(QWidget *parent, const QString &strContext) : QMessageBox(parent)
{
...
InfoMsgBox::InfoMsgBox(QWidget *parent, const QString &strContext) :
    QMessageBox(parent)
{
...
CriticalMsgBox::CriticalMsgBox(QWidget *parent, const QString &strContext) :
    QMessageBox(parent)
{
